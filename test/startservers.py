...
SERVICES = (
    ...
    Service('boulder-ca-a',
        ...
        # ('/usr/local/bin/dlv', '--listen=:4040', '--headless=true', '--log=true', '--log-output=debugger,debuglineerr,gdbwire,lldbout,rpc', '--api-version=2', '--accept-multiclient', '--output', 'boulder-ca', 'debug', '/boulder/cmd/boulder/main.go', '--', '--config', os.path.join(config_dir, 'ca-a.json'), '--ca-addr', 'ca1.service.consul:9093', '--ocsp-addr', 'ca1.service.consul:9096', '--crl-addr', 'ca1.service.consul:9106', '--debug-addr', ':8001'),
